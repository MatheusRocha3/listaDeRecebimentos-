...
public class valeRefeicao implements CalcularRecebimento{
    @Override
    public BigDecimal calculoPagamento(RecebimentosModel recebimentosModel) {
        return   recebimentosModel.getValorAReceber().subtract(recebimentosModel.getValorAReceber().multiply(new BigDecimal("0.042")));
    }
}
